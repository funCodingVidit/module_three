const userBike = require('./mobike.js');
...
r1.question("1. New User\n2. Existing User\n", (choice) => {
    switch (choice) {
        case "1": createUser();
            break;
        case "2": showRentalDetails();
            break;
        default: console.log("Choice not found");
    }


function createUser() {
    r1.question("Enter the following information\nEnter your name: ", (customerName) => {
        ...
        r1.question("Enter your phone number: ", (phoneNumber) => {
            ...
            r1.question("Enter your bike number", (bikeNumber) => {
                ...
                r1.question("Enter the days you want to rent the bike", (daysOfRent) => {
                    ...
                    const rentalCharge = mo.compute();

                    console.log("\nUser info with rental charge:" +
                    "\nName: "+ customer.customerName +
                     "\nPhone number: " + customer.phoneNumber + 
                     "\nBike number: " + customer.bikeNumber +
